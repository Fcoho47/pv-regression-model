"""
Train an ElasticNet regressor (with scaling) with plant holdout and save artifacts compatible with the backend.

Usage:
  python train_model_elastic.py --data-path datos_solcast_full-1764069958506.csv --run-name en_run
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Train ElasticNet with plant holdout.")
...
def main():
    ...
    run_name = args.run_name or f"en_{args.alpha}_{args.l1_ratio}_seed{args.seed}_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
