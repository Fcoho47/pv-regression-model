"""
Train a CatBoostRegressor with plant holdout and save artifacts compatible with the backend.

Usage:
  python train_model_catboost.py --data-path datos_solcast_full-1764069958506.csv --run-name cb_run
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Train CatBoost for regression with plant holdout.")
...
def main():
    ...
    run_name = args.run_name or f"cb_{args.iterations}_seed{args.seed}_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
